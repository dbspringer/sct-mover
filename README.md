...
Open the game options, pick SCT Mover under AddOns, and drag the "Target height" slider. `/sctmover` (or `/sctm`) takes you straight there. The Defaults button puts the numbers back where the game had them.
